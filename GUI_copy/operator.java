...
public class operator extends JFrame {
    private User obj;
    public operator(User obj) {
        this.obj = obj;
        initComponents();
    }

    private void menuItem5ActionPerformed(ActionEvent e) {//上传文档
        // TODO add your code here
        new up(obj).setVisible(true);
    ...
    private void menuItem4ActionPerformed(ActionEvent e) {//个人口令修改
        // TODO add your code here
        String ID = obj.getName();
        changeinfo Changeinfo = new changeinfo(ID,obj,operator.this);
